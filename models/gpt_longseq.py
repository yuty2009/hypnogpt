...
from models.modules import TransformerEncoderLayer
from models.modules import SinCosPositionalEmbedding1d
from models.modules import RoPEEmbedding1d
from models.gpt_transformers import GPT
...
class GPTLongSeqTransformer(nn.Module):
    def __init__(
            self, num_classes, vocab_size=0, seg_seqlen=30, max_segnum=512,
        ...
        self.pos_embed = SinCosPositionalEmbedding1d(embed_dim_seg, max_segnum, True)
        # self.pos_embed = RoPEEmbedding1d(embed_dim_seg, max_segnum, cls_token=True)
...
def load_from_pretrained_lm(model, pretrained, strict=False):
    """
